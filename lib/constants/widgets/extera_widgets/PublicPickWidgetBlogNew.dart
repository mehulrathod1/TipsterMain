...
import '../../../View/BUYER ADMIN/buyer_admin_susbscription.dart';
import '../../../View/login_screen.dart';
import '../../../utils/colors.dart';
import '../reportPopUp.dart';

class PublicPickWidgetBlogNew extends StatelessWidget {
  final bool isFollowing;
  final bool isUser;
  final bool isLoggedIn;

  const PublicPickWidgetBlogNew({
    Key? key,
  ...
  // @override
  // State<PublicPickWidgetBlog> createState() =>
  //     _PublicPickWidgetBlog(isFollowing, isUser, isLoggedIn);
        ...
        children: [
          Padding(
            padding: const EdgeInsets.only(
                top: 20.0, left: 10, right: 20, bottom: 20.0),
            child: Row(
