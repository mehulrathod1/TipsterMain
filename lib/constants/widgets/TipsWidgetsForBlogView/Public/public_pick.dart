...
// class _PublicPickWidgetBlog extends State<PublicPickWidgetBlog> {
//   late final bool isFollowing;
//   late final bool isUser;
//   late final bool isLoggedIn;
//
//   _PublicPickWidgetBlog(this.isFollowing, this.isUser, this.isLoggedIn);
//
//   @override
//   Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          Padding(
            padding: const EdgeInsets.only(
                top: 20.0, left: 0, right: 20, bottom: 20.0),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
