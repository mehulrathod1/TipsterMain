...
import 'package:tipster/constants/widgets/deposit_popup.dart';
        ...
        builder: (context) {
          return AlertDialog(
            ...
            content: Column(
              ...
              children: [
                Text(
                    'By confirming you will get subscribed to \"bloggername\"services and 55€ will be substracted from your balance ')
              ],
            ),
            actions: [
              Row(
